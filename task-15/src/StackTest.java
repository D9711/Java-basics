...
public abstract class StackTest {
    ...
    public void popFiveTimesDecreasesSizeByFive() {
        ...
        // Arrange
        pushArrayToStack(valuesInStack, emptyStack);
        int originalStackSize = emptyStack.size();

        // Act

       popElements(emptyStack, 5);

        // Assert
        assertTrue(emptyStack.size() == originalStackSize-5);
    ...
    public void pushFiveTimesIncreasesSizeByFive() {
        ...
        for(int i = 0; i < 5; i++) {
            ...
            emptyStack.push(toPush);
        }

        // Assert
        assertTrue(emptyStack.size() == stackSize + 5);
    }
    ...
    public void sizeIs0WhenAllElementsHaveBeenPopped() {
        ...
        popElements(emptyStack, emptyStack.size());
