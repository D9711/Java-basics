...
Add four new test cases for an `inverse` method in `CalculatorTest`. This method takes no arguments
...
possibly throw an exception. If there is complex arrangement and several different method calls,
